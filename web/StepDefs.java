...
public class StepDefs extends MyTestNGBaseClass {
    ...
    @When("I click button to {string}")
    public void clickLoginToApp(String clickButton) throws Throwable {
        clickElement(clickButton, 1);
    }
    ...
    @When("{string}  gsm sorgulandiginda")
    public void gsmSearch(String gsm) throws Throwable {
        enterText(gsm, "gsm text area", 1);
        clickElement("sorgula button", 1);
    }

    @When("gsm is queried from db")
    public void gsmSearchFromDb() throws Throwable {
        String gsmNo = dbFunction.selectFaturasizGSMNo();
        System.out.println(gsmNo);
        enterText(gsmNo, "gsm text area", 1);
        clickElement("sorgula button", 1);
    }

    @When("customer id db'den sorgulandiginda")
    public void customerIDSearchFromDb() throws Throwable {
        String customerID = dbFunction.selectCustomerID();
        System.out.println(customerID);
        enterText(customerID, "customer id box", 1);
    }

    @When("father name db'den sorgulandiginda")
    public void fatherNameSearchFromDb() throws Throwable {
        String fatherName = dbFunction.selectFatherName();
        System.out.println(fatherName);
        enterText(fatherName, "father name box", 1);
    }

    @When("mother name db'den sorgulandiginda")
    public void motherNameSearchFromDb() throws Throwable {
        String motherName = dbFunction.selectMotherName();
        System.out.println(motherName);
        enterText(motherName, "mother maiden name box", 1);
    }


    @When("document no db'den sorgulandiginda")
    public void documentNoSearchFromDb() throws Throwable {
        String documentNo = dbFunction.selectDocumentNo();
        System.out.println(documentNo);
        enterText(documentNo, "card serial no box", 1);
    }
    @When("name db'den sorgulandiginda")
    public void nameSearchFromDb() throws Throwable {
        String nameNo = dbFunction.selectName();
        System.out.println(nameNo);
        enterText(nameNo, "name box", 1);
    }

    @When("I change Gsm status")
    public void cangeGSmStatus() throws Throwable {
        String gsmNumber = dbFunction.changeGSMStatus();
        enterText(gsmNumber,"gsm text area", 1);
        clickElement("sorgula button", 1);
    ...
    @When("I update Gsm status")
    public void updateGSmStatus() throws Throwable {
       String gsmNumber = dbFunction.updateGSMStatus();
       System.out.println("update gsm status working");
       System.out.println(gsmNumber);

    }

    @When("I get gsm number for post to post")
    public void getGsmNumberPostToPost() throws Throwable {
        String gsmNumber = dbFunction.getPost2PostGSM();
        System.out.println("gsm number getting");
        System.out.println(gsmNumber);
...
//                }
    ...
    @When("Login To Koctas web page {string} and {string}")
    public void loginToKoctasWeb(String username, String password) throws Throwable {
        commonLib.loginToApp(username, password);
    }

    @When("I scroll down to {string} element")
    public void scrollDown(String element) throws InterruptedException {

        WebElement elem = commonLib.findElement(element,1);
        ((JavascriptExecutor) oDriver).executeScript("arguments[0].scrollIntoView(true);",elem);
